...
final class WP_Customize_Widgets {
	...
	/**
	 * Inspects the transaction for any widget settings, and dynamically adds
	...
	public function call_widget_update( $widget_id ) {
		 ...
		 */
		$setting_id = $this->get_setting_id( $widget_id );
		$this->manager->transaction->set( $this->manager->get_setting( $setting_id ), $this->sanitize_widget_js_instance( $instance ) );

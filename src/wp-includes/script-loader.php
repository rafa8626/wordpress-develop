...
function wp_default_scripts( &$scripts ) {
	...
	$scripts->add( 'common', "/wp-admin/js/common$suffix.js", array( 'jquery', 'hoverIntent', 'utils', 'underscore', 'wp-util' ), false, 1 );
	...
	if ( is_admin() ) {
		...
		// Navigation Menus
		$scripts->add( 'nav-menu', "/wp-admin/js/nav-menu$suffix.js", array( 'jquery-ui-sortable', 'jquery-ui-draggable', 'jquery-ui-droppable', 'wp-lists', 'postbox', 'json2', 'underscore', 'wp-util' ) );
